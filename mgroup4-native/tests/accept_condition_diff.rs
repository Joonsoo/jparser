...
use mgroup4_native::accept_condition::eval::{evaluate_accept_condition, evolve_accept_condition};
use mgroup4_native::accept_condition::parse::{parse_condition, parse_path_root};
use mgroup4_native::accept_condition::AcceptCondition;
use mgroup4_native::path_root::PathRoot;
...
fn load_blocks() -> Vec<Block> {
    ...
    let path = "../mgroup3-native/tests/fixtures/accept_condition.txt";
