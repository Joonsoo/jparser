...
use mgroup4_native::parser_data::ParserDataPlain;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for i in 0..iters {
        ...
        let parser_warm = Mgroup4Parser::from_plain(plain_warm);
        ...
        {
            use rkyv::rancor;
            use mgroup4_native::parser_data::ArchivedParserDataPlain;
