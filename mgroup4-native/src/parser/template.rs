...
//!
//! Port of `Mgroup4Parser.kt:853-891` (the `toAcceptCondition` extension) plus
...
/// Mirrors `Mgroup4Parser.kt:379-386`. Unknown / default falls back to `prev`.
...
/// against the four reference points. Mirrors `Mgroup4Parser.kt:853-891`.
///
