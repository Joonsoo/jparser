...
//!
//! See `mgroup3/schema/proto/Mgroup4ParserResult.proto` for the wire format
//! and `mgroup3/nativeParser/kotlin/.../Mgroup3NativeResult.kt` for the
//! Kotlin-side decoder.

use prost::Message as ProstMessage;

use crate::parser::Mgroup4Parser;
...
fn build_history_msg(parser: &Mgroup4Parser, ctx: &ParsingCtx) -> KernelsHistoryMsg {
...
mod tests {
    ...
    fn accepted_initial_finish() {
        ...
        // single-gen history.
        let parser = Mgroup4Parser::new(always_self_finish_data(7));
    ...
    fn accepted_field_matches_outcome() {
        ...
        let parser2 = Mgroup4Parser::new(empty_data_with_start(1));
