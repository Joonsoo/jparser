...
object Stage4RustEmit {
  fun run(
    ...
    binDir.resolve("check_ast.rs").writeText(CHECK_AST_RS)
  }
   ...
   */
  private val CHECK_AST_RS: String = """
    ...
    |use prost::Message;
    |
    |use mgroup3_generated_parser::ast::Ctx;
    |use mgroup3_generated_parser::ktlib::{Kernel, KernelSet};
