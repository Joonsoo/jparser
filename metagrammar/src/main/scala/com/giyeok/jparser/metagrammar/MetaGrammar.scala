package com.giyeok.jparser.metagrammar

import com.giyeok.jparser.GrammarHelper.{anychar, c, chars, empty, longest, lookahead_except, lookahead_is, n, oneof, proxyIfNeeded, seq, seqWS, _}
import com.giyeok.jparser.ParseResultTree.{BindNode, JoinNode, Node, SequenceNode, TerminalNode}
import com.giyeok.jparser.Symbols.{Any, AnyChar, ExactChar, Except, Join, Longest, LookaheadExcept, LookaheadIs, Nonterminal, OneOf, Proxy, Repeat, Sequence, Start}
...
object MetaGrammar extends Grammar {
    ...
    class NewGrammar(val name: String, val rules: ListMap[String, ListSet[Symbols.Symbol]], val start: String) extends Grammar
    ...
    def translate(name: String, tree: ParseResultTree.Node): Grammar = {
        ...
        val startSymbol = nontermDefs.head._1
