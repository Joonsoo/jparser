...
class BibixAst(
  ...
  fun matchDefs(beginGen: Int, endGen: Int): List<Def> {
    ...
    val var13 = unrollRepeat0(history, 450, 452, 11, 451, var11[1].first, var11[1].second).map { k ->
  ...
  fun matchName(beginGen: Int, endGen: Int): Name {
    ...
    val var18 = unrollRepeat0(history, 125, 127, 11, 126, var16[1].first, var16[1].second).map { k ->
  ...
  fun matchSimpleName(beginGen: Int, endGen: Int): String {
    ...
    return source[var24[0].first].toString() + var25.joinToString("") { it.toString() }
  }
  ...
  fun matchDef(beginGen: Int, endGen: Int): Def {
    ...
    check(hasSingleTrue(var26 != null, var27 != null, var28 != null, var29 != null, var30 != null, var31 != null, var32 != null, var33 != null, var34 != null, var35 != null))
    val var36 = when {
      var26 != null -> {
  ...
  fun matchActionRuleDef(beginGen: Int, endGen: Int): ActionRuleDef {
    val var57 = getSequenceElems(history, 393, listOf(331,8,394,8,88,8,357,8,230,8,398), beginGen, endGen)
  ...
  fun matchBuildRuleDef(beginGen: Int, endGen: Int): BuildRuleDef {
    val var62 = getSequenceElems(history, 449, listOf(394,8,88,8,357,8,205,8,178,8,230,8,398), beginGen, endGen)
      ...
      var68 != null -> {
        ...
        val var75 = when {
          var73 != null -> null
            ...
            val var76 = getSequenceElems(history, 318, listOf(8,155,8,88), var71[3].first, var71[3].second)
        ...
        val var79 = getSequenceElems(history, 319, listOf(320,8,153,8,138,8,86,315), beginGen, endGen)
        ...
        val var84 = when {
          var82 != null -> null
            ...
            val var85 = getSequenceElems(history, 318, listOf(8,155,8,88), var79[7].first, var79[7].second)
  ...
  fun matchNoUnionType(beginGen: Int, endGen: Int): NoUnionType {
    ...
    check(hasSingleTrue(var97 != null, var98 != null, var99 != null, var100 != null, var101 != null))
    val var102 = when {
      var97 != null -> {
  ...
  fun matchParamsDef(beginGen: Int, endGen: Int): List<ParamDef> {
    ...
    val var133 = when {
      var131 != null -> null
        ...
        val var134 = getSequenceElems(history, 362, listOf(8,363,374), var130[1].first, var130[1].second)
        val var135 = matchParamDef(var134[1].first, var134[1].second)
        val var136 = unrollRepeat0(history, 374, 376, 11, 375, var134[2].first, var134[2].second).map { k ->
  ...
  fun matchTypeParams(beginGen: Int, endGen: Int): TypeParams {
    ...
    val var141 = unrollRepeat0(history, 191, 193, 11, 192, var139[3].first, var139[3].second).map { k ->
  ...
  fun matchActionDef(beginGen: Int, endGen: Int): ActionDef {
    ...
    val var149 = when {
      var147 != null -> null
        ...
        val var150 = getSequenceElems(history, 337, listOf(8,338), var145[3].first, var145[3].second)
  ...
  fun matchActionBody(beginGen: Int, endGen: Int): ActionBody {
    ...
    val var158 = when {
      var156 != null -> {
        ...
        val var163 = unrollRepeat1(history, 344, 345, 345, 348, var162[1].first, var162[1].second).map { k ->
  ...
  fun matchTupleType(beginGen: Int, endGen: Int): TupleType {
    ...
    val var175 = unrollRepeat0(history, 191, 193, 11, 192, var173[3].first, var173[3].second).map { k ->
  ...
  fun matchDataClassDef(beginGen: Int, endGen: Int): DataClassDef {
    ...
    val var192 = when {
      var190 != null -> null
        ...
        val var193 = getSequenceElems(history, 382, listOf(8,383), var186[5].first, var186[5].second)
  ...
  fun matchMethodRef(beginGen: Int, endGen: Int): MethodRef {
    ...
    val var201 = when {
      var199 != null -> null
        ...
        val var202 = getSequenceElems(history, 403, listOf(8,205,8,88), var196[5].first, var196[5].second)
  ...
  fun matchClassBody(beginGen: Int, endGen: Int): List<ClassBodyElem> {
    ...
    val var206 = unrollRepeat0(history, 385, 387, 11, 386, var205[1].first, var205[1].second).map { k ->
  ...
  fun matchClassCastDef(beginGen: Int, endGen: Int): ClassCastDef {
    val var216 = getSequenceElems(history, 406, listOf(155,8,178,8,230,8,153), beginGen, endGen)
  ...
  fun matchVarDef(beginGen: Int, endGen: Int): VarDef {
    ...
    val var224 = when {
      var222 != null -> null
        ...
        val var225 = getSequenceElems(history, 434, listOf(8,205,8,178), var220[3].first, var220[3].second)
    ...
    val var229 = when {
      var227 != null -> null
        ...
        val var230 = getSequenceElems(history, 373, listOf(8,230,8,153), var220[4].first, var220[4].second)
  ...
  fun matchEnumDef(beginGen: Int, endGen: Int): EnumDef {
    val var237 = getSequenceElems(history, 420, listOf(421,8,88,8,183,8,88,413,221,8,190), beginGen, endGen)
    val var238 = matchSimpleName(var237[2].first, var237[2].second)
    val var239 = matchSimpleName(var237[6].first, var237[6].second)
    val var240 = unrollRepeat0(history, 413, 415, 11, 414, var237[7].first, var237[7].second).map { k ->
  ...
  fun matchPrimary(beginGen: Int, endGen: Int): Primary {
    ...
    check(hasSingleTrue(var244 != null, var245 != null, var246 != null, var247 != null, var248 != null, var249 != null, var250 != null, var251 != null, var252 != null))
    val var253 = when {
      var244 != null -> {
      ...
      var247 != null -> {
        ...
        val var267 = when {
          var265 != null -> null
            ...
            val var268 = getSequenceElems(history, 244, listOf(8,245,250,221), var264[1].first, var264[1].second)
            val var269 = matchListElem(var268[1].first, var268[1].second)
            val var270 = unrollRepeat0(history, 250, 252, 11, 251, var268[2].first, var268[2].second).map { k ->
              val var271 = getSequenceElems(history, 254, listOf(8,189,8,245), k.first, k.second)
      ...
      var248 != null -> {
        val var274 = getSequenceElems(history, 256, listOf(148,8,153,8,189,257,8,149), beginGen, endGen)
        ...
        val var279 = when {
          var277 != null -> null
            ...
            val var280 = getSequenceElems(history, 260, listOf(8,153,216,221), var274[5].first, var274[5].second)
            val var281 = matchExpr(var280[1].first, var280[1].second)
            val var282 = unrollRepeat0(history, 216, 218, 11, 217, var280[2].first, var280[2].second).map { k ->
              val var283 = getSequenceElems(history, 220, listOf(8,189,8,153), k.first, k.second)
      ...
      var249 != null -> {
        ...
        val var290 = when {
          var288 != null -> null
            ...
            val var291 = getSequenceElems(history, 265, listOf(8,266,268,221), var287[1].first, var287[1].second)
            val var292 = matchNamedExpr(var291[1].first, var291[1].second)
            val var293 = unrollRepeat0(history, 268, 270, 11, 269, var291[2].first, var291[2].second).map { k ->
              val var294 = getSequenceElems(history, 272, listOf(8,189,8,266), k.first, k.second)
  ...
  fun matchStringLiteral(beginGen: Int, endGen: Int): StringLiteral {
    ...
    val var314 = unrollRepeat0(history, 279, 281, 11, 280, var313[1].first, var313[1].second).map { k ->
  ...
  fun matchStringElem(beginGen: Int, endGen: Int): StringElem {
    ...
    val var322 = when {
      var319 != null -> {
        ...
        val var324 = JustChar(source[var323[0].first], nextId(), beginGen, endGen)
        var324
      }
      var320 != null -> {
  ...
  fun matchEscapeChar(beginGen: Int, endGen: Int): EscapeChar {
    ...
    val var330 = EscapeChar(source[var329[1].first], nextId(), beginGen, endGen)
    return var330
  }
  ...
  fun matchStringExpr(beginGen: Int, endGen: Int): StringExpr {
    ...
    val var333 = when {
      var331 != null -> {
        ...
        val var335 = getSequenceElems(history, 300, listOf(301,88), var334[0].first, var334[0].second)
        val var336 = matchSimpleName(var335[1].first, var335[1].second)
        val var337 = SimpleExpr(var336, nextId(), beginGen, endGen)
        var337
      }
      else -> {
        val var338 = getSequenceElems(history, 302, listOf(301,183,8,153,8,190), beginGen, endGen)
  ...
  fun matchVarRedefs(beginGen: Int, endGen: Int): VarRedefs {
    ...
    val var347 = unrollRepeat0(history, 442, 444, 11, 443, var345[3].first, var345[3].second).map { k ->
  ...
  fun matchVarRedef(beginGen: Int, endGen: Int): VarRedef {
    ...
    val var353 = unrollRepeat1(history, 440, 127, 127, 441, var351[1].first, var351[1].second).map { k ->
  ...
  fun matchParamDef(beginGen: Int, endGen: Int): ParamDef {
    ...
    val var375 = when {
      var373 != null -> {
        ...
        val var380 = getSequenceElems(history, 364, listOf(88,365,8,205,8,178,370), beginGen, endGen)
        ...
        val var384 = when {
          var382 != null -> null
            ...
            val var385 = getSequenceElems(history, 368, listOf(8,369), var380[1].first, var380[1].second)
            source[var385[1].first]
          }
        }
        ...
        val var389 = when {
          var387 != null -> null
            ...
            val var390 = getSequenceElems(history, 373, listOf(8,230,8,153), var380[6].first, var380[6].second)
  ...
  fun matchUnionType(beginGen: Int, endGen: Int): UnionType {
    ...
    val var395 = unrollRepeat0(history, 184, 186, 11, 185, var393[3].first, var393[3].second).map { k ->
  ...
  fun matchSuperClassDef(beginGen: Int, endGen: Int): SuperClassDef {
    val var403 = getSequenceElems(history, 409, listOf(410,8,354,8,88,8,183,8,88,413,8,190), beginGen, endGen)
    val var404 = matchSimpleName(var403[4].first, var403[4].second)
    val var405 = matchSimpleName(var403[8].first, var403[8].second)
    val var406 = unrollRepeat0(history, 413, 415, 11, 414, var403[9].first, var403[9].second).map { k ->
  ...
  fun matchCallParams(beginGen: Int, endGen: Int): CallParams {
    ...
    val var414 = when {
      ...
      var411 != null -> {
        val var416 = getSequenceElems(history, 150, listOf(148,8,151,221,8,149), beginGen, endGen)
      ...
      var412 != null -> {
        val var419 = getSequenceElems(history, 225, listOf(148,8,226,221,8,149), beginGen, endGen)
        val var420 = matchNamedParams(var419[2].first, var419[2].second)
        val var421 = CallParams(listOf(), var420, nextId(), beginGen, endGen)
        var421
      }
      else -> {
        val var422 = getSequenceElems(history, 236, listOf(148,8,151,8,189,8,226,221,8,149), beginGen, endGen)
  ...
  fun matchPositionalParams(beginGen: Int, endGen: Int): List<Expr> {
    ...
    val var428 = unrollRepeat0(history, 216, 218, 11, 217, var426[1].first, var426[1].second).map { k ->
  ...
  fun matchNamedParams(beginGen: Int, endGen: Int): List<NamedParam> {
    ...
    val var433 = unrollRepeat0(history, 231, 233, 11, 232, var431[1].first, var431[1].second).map { k ->
  ...
  fun matchNamedTupleType(beginGen: Int, endGen: Int): NamedTupleType {
    ...
    val var442 = unrollRepeat0(history, 206, 208, 11, 207, var440[3].first, var440[3].second).map { k ->
