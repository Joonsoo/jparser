...
object MetaLang2Grammar extends MetaLangExamples {
    val inMetaLang1 = MetaLang1Example("Meta Language 2",
    ...
    val inMetaLang2 = MetaLang2Example("Meta Language 2",
    ...
    val examples: List[MetaLangExample] = List(inMetaLang1, inMetaLang1)
}
