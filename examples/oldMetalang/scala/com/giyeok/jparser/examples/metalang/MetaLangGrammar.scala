...
import com.giyeok.jparser.examples.metalang2.MetaLang2Grammar
import com.giyeok.jparser.examples.{MetaLang1Example, MetaLang2Example, MetaLangExample, MetaLangExamples}
...
object MetaLangGrammar extends MetaLangExamples {
  ...
  val metaGrammar2 = MetaLang1Example("MetaGrammar2", metaGrammarText2,
    correctExamples = correctExamples, incorrectExamples = incorrectExamples)
  val metaGrammar2a = MetaLang2Example("Meta Language 2 in MetaLang1", MetaLang2Grammar.inMetaLang1)

  val examples: List[MetaLangExample] = List(metaGrammar1, metaGrammar2, metaGrammar2a)
}
