...
import com.giyeok.jparser.metalang3.MetaLanguage3.{ProcessedGrammar, writeScalaParserCode}
import com.giyeok.jparser.metalang3.codegen.ScalaCodeGen
import com.giyeok.jparser.metalang3.codegen.ScalaCodeGen.InlineProtoDef
...
object Grammars {
  ...
  def generateMetaLang3Ast(): Unit =
    generateScalaParserCode("MetaLang3Ast", MetaLang3Grammar.inMetaLang3,
